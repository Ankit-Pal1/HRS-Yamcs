...
def receive_tc(simulator):
    ...
    while True:
        ...
        print(simulator.last_tc)

def execute_ping_command(command, args):
    # Access the command argument using the 'args' parameter
    ping_argument = args['pingArgument']

    # Perform the desired action with the provided argument (6 in this case)
    # For example, you can send a ping message to the target specified by 'ping_argument'
    print(f"Sending ping message to {ping_argument}")
